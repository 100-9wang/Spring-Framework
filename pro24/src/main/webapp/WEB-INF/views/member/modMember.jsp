...
<style>
    ...
    .container {
        ...
        text-align: center;
        width: 100%;
        max-width: 500px; /* 최대 너비 설정 (원하는 값으로 조정 가능) */
        padding: 20px;
...
<body>
    <div class="container">
        <form method="post" action="${contextPath}/member/modMembers.do">
            <h1 class="text-center" style="color:#6699FF;">회원 정보 수정창</h1>
